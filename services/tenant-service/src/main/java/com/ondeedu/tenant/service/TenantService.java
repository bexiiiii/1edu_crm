    ...
    public TenantDto createTenant(CreateTenantRequest request) {
        ...
        try {
            ...
            entityManager.createNativeQuery("SELECT system.ensure_apipay_schema(:schemaName)")
                .setParameter("schemaName", schemaName)
                .getSingleResult();
            entityManager.createNativeQuery("SELECT system.ensure_aisar_schema(:schemaName)")
                .setParameter("schemaName", schemaName)
                .getSingleResult();
            ...
            entityManager.createNativeQuery("SELECT system.ensure_inventory_schema(:schemaName)")
                .setParameter("schemaName", schemaName)
                .getSingleResult();
            entityManager.createNativeQuery("SELECT system.ensure_inventory_revision_schema(:schemaName)")
                .setParameter("schemaName", schemaName)
                .getSingleResult();
